    ...
    switch ($action) {
        ...
        case 'stats':
            ...
            $stats = [
                ...
                'by_user_type' => AuditLog::where('created_at', '>=', now()->subDays($days))
                ...
                'by_action' => AuditLog::where('created_at', '>=', now()->subDays($days))
                    ...
                    ->limit(10)
                    ->get(),
                'by_status' => AuditLog::where('created_at', '>=', now()->subDays($days))
        ...
        case 'delete':
            ...
            $admin = Admin::where('username', $_SESSION['user_data']['username'])->first();
